        ...
        <div className="grid grid-cols-3 gap-5 mt-10">
          <div className="relative h-[800px] overflow-auto">
            ...
            <div className="space-y-3">
              {pendingTask.map((task) => <TaskCard key={task.id} task={task}></TaskCard>)}
            </div>
          </div>
          <div className="relative h-[800px] overflow-auto">
            <div className="flex sticky top-0 justify-between bg-[#D3DDF9] p-5 rounded-md mb-3">
            ...
            <div className="space-y-3">
            {runningTask.map((task) => <TaskCard key={task.id} task={task}></TaskCard>)}
            </div>
          </div>
          <div className="relative h-[800px] overflow-auto">
            <div className="flex sticky top-0 justify-between bg-[#D3DDF9] p-5 rounded-md mb-3">
            ...
            <div className="space-y-3">
            {doneTask.map((task) => <TaskCard key={task.id} task={task}></TaskCard>)}
            </div>
          </div>
        </div>
      </div>
